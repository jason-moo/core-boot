...
public class RedisUtils {
    ...
    public static void setExpireAt(final String key, final Date date) {
        int expireTime = com.xzn.common.utils.DateUtils.getSecondsBetween(new Date(), date);
    ...
    public static void hput(final String key, final String field, final Object value) {
        ...
        template.execute(
                (RedisConnection connection) -> connection.hSet(SafeEncoder.encode(key), SafeEncoder.encode(field),
                        SerializeUtils
                                .serialize(value)));
    }
    ...
    public static void hremove(final String key, final String field) {
        ...
        template.execute(
                (RedisConnection connection) -> connection.hDel(SafeEncoder.encode(key), SafeEncoder.encode(field)));
    }
    ...
    public static Long rpush(final String key, final String... value) {
        ...
        return (Long) template.execute((RedisConnection connection) -> connection.rPush(SafeEncoder.encode(key),
                SafeEncoder.encodeMany(value)));
    }
    ...
    public static Long lrem(final String key, final String value, final int count) {
        return (Long) template.execute((RedisConnection connection) -> connection.lRem(SafeEncoder.encode(key), count,
    ...
    public static Double incrByFloat(final String key, final double num) {
        ...
        return (Double) template.execute(
                (RedisConnection connection) -> connection.incrBy(SafeEncoder.encode(key), num));
    }
    ...
    public static Set<byte[]> keys(final String pattern) {
        return (Set<byte[]>) template.execute(
                (RedisConnection connection) -> connection.keys(SafeEncoder.encode(pattern)));
    }
